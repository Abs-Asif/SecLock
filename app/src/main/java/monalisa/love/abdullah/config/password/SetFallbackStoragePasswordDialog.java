...
public final class SetFallbackStoragePasswordDialog extends PasswordDialog {

    public SetFallbackStoragePasswordDialog(Activity activity, LockStore lockStore, Runnable onSuccess) {
        super(activity, lockStore, onSuccess, R.string.fallback_storage_password_set_title,
                R.layout.password_first_set);
    }

    public SetFallbackStoragePasswordDialog(Activity activity, LockStore lockStore, Runnable onSuccess, Runnable onCancel) {
        super(activity, lockStore, onSuccess, onCancel, R.string.fallback_storage_password_set_title,
                R.layout.password_first_set);
    }
    ...
    protected void build() {
        ...
        positiveBtn.setOnClickListener(v -> {
            ...
            if (lockStore.setFallbackStoragePassword(passwordValue)) {
                dismiss();
                onSuccess.run();
            }
        });
